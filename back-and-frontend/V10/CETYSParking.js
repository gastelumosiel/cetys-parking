...
const app = createApp({
    data() { 
        return {
            ...
            parkingData: {
                '1': [
                    { id: 1, numero: 'PS001', estado: 'conectando', ocupadoDesde: null, timestamp: null },
                    { id: 2, numero: 'PS002', estado: 'conectando', ocupadoDesde: null, timestamp: null },
                    { id: 3, numero: 'PS003', estado: 'conectando', ocupadoDesde: null, timestamp: null },
                    { id: 4, numero: 'PS004', estado: 'conectando', ocupadoDesde: null, timestamp: null },
                    { id: 5, numero: 'PS005', estado: 'conectando', ocupadoDesde: null, timestamp: null },
                    { id: 6, numero: 'PS006', estado: 'conectando', ocupadoDesde: null, timestamp: null },
                    { id: 7, numero: 'PS007', estado: 'conectando', ocupadoDesde: null, timestamp: null },
                    { id: 8, numero: 'PS008', estado: 'conectando', ocupadoDesde: null, timestamp: null }
                ],
                '2': [
                    { id: 1, numero: 'PS001', estado: 'conectando', ocupadoDesde: null, timestamp: null },
                    { id: 2, numero: 'PS002', estado: 'conectando', ocupadoDesde: null, timestamp: null },
    ...
    mounted() {
        ...
        console.log('  - Total cajones:', this.currentSpots.length)
        console.log('  - Todos en estado: conectando (esperando datos de sensores)')
        console.log('========================================')
